...
public class MongoTtvBackend extends MongoBackend implements TtvStorageInterface {
	
//	private MongoCollection<TwitchUser> twitchUserCollection;
...
//		twitchUserCollection = createCollectionIfNotExists("twitch_users", TwitchUser.class).withCodecRegistry(codecRegistry);
//		adminCollection = createCollectionIfNotExists("admin", NamedOAuth2Credential.class).withCodecRegistry(codecRegistry);
